package animations.animatedModel;
...
import animations.animation.Animator;
...
public class AnimatedModel {
    ...
    // skin
    private final AnimatedMesh model;
     ...
     *
     */
    public AnimatedModel(AnimatedMesh model, Texture texture, Joint rootJoint, int jointCount) {
        this.model = model;
