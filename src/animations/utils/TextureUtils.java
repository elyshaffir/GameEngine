package animations.utils;

import java.io.InputStream;
import java.nio.ByteBuffer;

import animations.renderingData.TextureBuilder;
import animations.renderingData.TextureData;
...
public class TextureUtils {
    ...
    public static TextureData decodeTextureFile(PNGFile file) {
        int width = 0;
        int height = 0;
