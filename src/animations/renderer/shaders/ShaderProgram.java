package animations.renderer.shaders;
...
public class ShaderProgram {
	...
	public ShaderProgram(GLSLFile vertexFile, GLSLFile fragmentFile, String... inVariables) {
	...
	private int loadShader(GLSLFile file, int type) {
